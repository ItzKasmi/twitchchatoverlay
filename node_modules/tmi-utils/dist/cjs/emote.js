...
exports.parseEmotesInMessage = exports.getEmoteAsUrl = void 0;
function getEmoteAsUrl(id, theme = 'light', scale = '2.0') {
    return `https://static-cdn.jtvnw.net/emoticons/v2/${id}/default/${theme}/${scale}`;
}
exports.getEmoteAsUrl = getEmoteAsUrl;
...
exports.parseEmotesInMessage = parseEmotesInMessage;
